...
=== "SVG (interactive)"
    ...
    <!-- Generated by graphviz version 14.1.3 (20260303.0454)
     -->
    <!-- Pages: 1 -->
    <svg width="251pt" height="445pt"
     viewBox="0.00 0.00 251.00 445.00" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <g id="graph0" class="graph" transform="scale(1 1) rotate(0) translate(4 440.5)">
    <polygon fill="white" stroke="none" points="-4,4 -4,-440.5 246.59,-440.5 246.59,4 -4,4"/>
    ...
    <polygon fill="lightgray" stroke="none" points="48,-410.38 48,-426.62 164,-426.62 164,-410.38 48,-410.38"/>
    <text xml:space="preserve" text-anchor="start" x="49" y="-414.38" font-family="Arial" font-size="12.00">TravelledWaySection</text>
    <polygon fill="none" stroke="black" points="47,-409.38 47,-427.62 165,-427.62 165,-409.38 47,-409.38"/>
    </a>
    </g>
    </g>
    <!-- RailSection -->
    ...
    <path fill="none" stroke="black" d="M106,-363.21C106,-370.97 106,-380.42 106,-389.24"/>
    <polygon fill="none" stroke="black" points="102.5,-389.16 106,-399.16 109.5,-389.16 102.5,-389.16"/>
    </g>
    <!-- Invis -->
    <!-- RailSection&#45;&gt;Invis -->
    <!-- RailNetwork -->
    ...
    <polygon fill="lightgray" stroke="none" points="24,-184.38 24,-200.62 92,-200.62 92,-184.38 24,-184.38"/>
    <text xml:space="preserve" text-anchor="start" x="25" y="-188.38" font-family="Arial" font-size="12.00">RailNetwork</text>
    <polygon fill="none" stroke="black" points="23,-183.38 23,-201.62 93,-201.62 93,-183.38 23,-183.38"/>
    </a>
    </g>
    </g>
    <!-- RailSection&#45;&gt;RailNetwork -->
    <g id="edge9" class="edge">
    <title>RailSection&#45;&gt;RailNetwork</title>
    <path fill="none" stroke="black" stroke-dasharray="5,2" d="M101.82,-327.52C96.9,-308.04 88.22,-275.2 79,-247.5 76.09,-238.74 72.56,-229.32 69.24,-220.84"/>
    <polygon fill="black" stroke="black" points="72.58,-219.76 65.62,-211.77 66.08,-222.36 72.58,-219.76"/>
    <polygon fill="white" stroke="none" points="93.07,-247.5 93.07,-290.5 193.32,-290.5 193.32,-247.5 93.07,-247.5"/>
    ...
    <text xml:space="preserve" text-anchor="start" x="166.59" y="-276" font-family="Arial" font-size="11.00">redefines</text>
    <text xml:space="preserve" text-anchor="start" x="138.84" y="-254.5" font-family="Arial" font-size="11.00">cdm1:hasProperPart</text>
    </g>
    <!-- Invis&#45;&gt;RailNetwork -->
    <!-- TrackLink -->
    ...
    <polygon fill="lightgray" stroke="none" points="31.12,-98.88 31.12,-115.12 84.88,-115.12 84.88,-98.88 31.12,-98.88"/>
    <text xml:space="preserve" text-anchor="start" x="32.12" y="-102.88" font-family="Arial" font-size="12.00">TrackLink</text>
    <polygon fill="none" stroke="black" points="30.12,-97.88 30.12,-116.12 85.88,-116.12 85.88,-97.88 30.12,-97.88"/>
    </a>
    </g>
    </g>
    ...
    <g id="a_node6"><a xlink:href="../TrackSegment" xlink:title="&lt;TABLE&gt;">
