...
=== "SVG (interactive)"
    ...
    <path fill="none" stroke="black" stroke-dasharray="5,2" d="M247.95,-187.16C258.38,-186.83 266,-185.61 266,-183.5 266,-182.28 263.45,-181.36 259.29,-180.73"/>
    <polygon fill="black" stroke="black" points="259.71,-177.26 249.46,-179.96 259.16,-184.23 259.71,-177.26"/>
    <polygon fill="white" stroke="none" points="266,-162 266,-205 373.75,-205 373.75,-162 266,-162"/>
    <text xml:space="preserve" text-anchor="start" x="297.75" y="-190.5" font-family="Arial" font-size="11.00">redefines</text>
    <text xml:space="preserve" text-anchor="start" x="270" y="-169" font-family="Arial" font-size="11.00">cdm1:hasProperPart</text>
    </g>
    <!-- NetworkElement&#45;&gt;NetworkElement -->
    <g id="edge7" class="edge">
    <title>NetworkElement&#45;&gt;NetworkElement</title>
    <path fill="none" stroke="black" d="M247.72,-189.62C299.87,-192.69 373.75,-190.65 373.75,-183.5 373.75,-176.85 309.89,-174.63 259.01,-176.81"/>
    <polygon fill="black" stroke="black" points="259.04,-173.31 249.23,-177.31 259.39,-180.3 259.04,-173.31"/>
    <polygon fill="white" stroke="none" points="373.75,-172.75 373.75,-194.25 474,-194.25 474,-172.75 373.75,-172.75"/>
    <text xml:space="preserve" text-anchor="start" x="377.75" y="-179.75" font-family="Arial" font-size="11.00">cdm1:properPartOf</text>
    </g>
    <!-- Invis -->
...
| [cdm1:hasProperPart](https://w3id.org/citydata/part1/v1/hasProperPart) | only [NetworkElement](NetworkElement.md) |
...
| [cdm1:properPartOf](https://w3id.org/citydata/part1/v1/properPartOf) | only [NetworkElement](NetworkElement.md) |
...
| [status](../properties/status.md) | only [ScheduledCode](ScheduledCode.md) |
...
| Class | Property |
|-------|----------|
| [Network Element (cdm1)](NetworkElement.md) | [cdm1:hasProperPart](https://w3id.org/citydata/part1/v1/hasProperPart) |
| [Network Element (cdm1)](NetworkElement.md) | [cdm1:properPartOf](https://w3id.org/citydata/part1/v1/properPartOf) |
| [Transport Alert](TransportAlert.md) | [affects](../properties/affects.md) |
